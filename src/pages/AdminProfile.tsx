...
export function AdminProfile() {
    ...
    // Formulario - Solo el nombre completo
    const [fullName, setFullName] = useState("");
    useEffect(() => {
        // Sirve para verificar autenticación
        if (!getToken()) {
            navigate("/login");
            return;
        }
    ...
    const loadProfile = async () => {
        //En caso de que funcione, mostrara el nombre completo de la persona
        try {
            setLoading(true);
            setError(null);
    ...
    /*Sirve para exportar archivos relacionados a clientes, ventas y productos */
                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <form onSubmit={handleSave} className="space-y-6">
                            {/* Email (solo lectura gracias al disabled en input) */}
                            <div>
